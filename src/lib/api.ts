...
/** Степень достоверности хадиса по науке о хадисах (ильм аль-хадис) */
...
export interface Hadith {
  ...
  narrator: string;
  source: string;
  /** Степень достоверности — проставляется из HADITH_GRADES по каноническому номеру */
  grade?: HadithGrade;
}

// Русские подписи и цвета степеней достоверности для UI
...
const NAWAWI_HADITHS: Hadith[] = [
  ...
  },
  {
    ...
    source: "Аль-Бухари, 2697; Муслим, 1718",
  },
  {
    id: 5,
    number: 6,
  ...
  },
  {
    ...
    source: "Аль-Бухари, 7288; Муслим, 1337",
  },
  {
    id: 8,
    number: 10,
  ...
  },
  {
    ...
    narrator: "Абу Хурайра (да будет доволен им Аллах)",
    source: "Ат-Тирмизи, 2318; Ибн Маджа, 3976",
  },
  {
    id: 10,
    number: 13,
  ...
  },
  {
    ...
    source: "Абу Дауд, 4607; Ат-Тирмизи, 2676",
  },
  {
    id: 25,
    number: 29,
  ...
  },
  {
    ...
    source: "Ибн Маджа, 2340; Ад-Даракутни, 4/228",
  },
  {
    id: 29,
    number: 33,
  ...
  },
  {
    ...
    narrator: "Ибн Аббас (да будет доволен ими обоими Аллах)",
    source: "Аль-Бухари, 6491; Муслим, 131",
  },
  {
    id: 34,
    number: 38,
  ...
  },
  {
    ...
    narrator: "Ибн Аббас (да будет доволен ими обоими Аллах)",
    source: "Ибн Маджа, 2045; Аль-Байхаки, 7/356",
  },
  {
    id: 36,
    number: 40,
  ...
  },
  {
    ...
    source: "Ан-Навави, аль-Арбаин, 41",
  },
  {
    id: 38,
    number: 42,
    ...
    source: "Ат-Тирмизи, 3540",
  },
  // ── Недостающие канонические хадисы ан-Навави (тексты из выверенного
  //    Сахих аль-Бухари, рус. перевод; арабский — издание ан-Навави) ──
  {
    id: 39,
    number: 4,
    arabic:
    ...
    russian:
      "Поистине, каждый из вас (сначала) формируется во чреве своей матери в течение сорока дней, затем он столько же пребывает (там) в виде сгустка крови и ещё столько же — в виде кусочка плоти, а затем Аллах направляет ангела, который вдувает в него дух и получает веление записать четыре вещи: его удел, его срок, его дела, а также то, счастливым он будет или злосчастным. И, поистине, любой из вас может совершать (благие) дела, пока не окажется от Рая на расстоянии (одного лишь) локтя, и тогда сбудется записанное ему, и станет он совершать дела обитателей Огня. И (так же) может совершать (дурное), пока не окажется от Огня на расстоянии локтя, и тогда сбудется записанное ему, и станет он совершать дела обитателей Рая.",
    narrator: "Абдуллах ибн Мас’уд (да будет доволен им Аллах)",
    source: "Аль-Бухари, 3208; Муслим, 2643",
  },
  {
    id: 40,
    number: 8,
    ...
    russian:
      "Мне было велено сражаться с (этими) людьми до тех пор, пока они не засвидетельствуют, что нет божества, достойного поклонения, кроме Аллаха, и что Мухаммад — Посланник Аллаха, и не станут совершать молитву и выплачивать закят. А если они будут делать всё это, то защитят от меня свою кровь и своё имущество, кроме как по праву Ислама, и (тогда) отчёта с них (вправе будет требовать только) Аллах.",
    narrator: "Абдуллах ибн Умар (да будет доволен ими обоими Аллах)",
    source: "Аль-Бухари, 25; Муслим, 22",
  },
  {
    id: 41,
    number: 14,
    ...
    russian:
      "Не дозволена кровь мусульманина, свидетельствующего о том, что нет божества, достойного поклонения, кроме Аллаха, и что я — Посланник Аллаха, кроме как в трёх случаях: женатый прелюбодей; (лишение) жизни за жизнь; и тот, кто отступил от своей религии и покинул общину.",
    narrator: "Абдуллах ибн Мас’уд (да будет доволен им Аллах)",
    source: "Аль-Бухари, 6878; Муслим, 1676",
  },
];

// Градация 40 хадисов ан-Навави по каноническому номеру (number).
// Устоявшаяся в науке о хадисах: Бухари/Муслим → сахих; ряд хадисов из
// Тирмизи/Ибн Маджа/Даракутни/Байхаки → хасан; добавленный №41 → даиф
// (сам ан-Навави считал его сильным, но большинство мухаддисов — слабым).
const HADITH_GRADES: Record<number, HadithGrade> = {
  1: "sahih", 2: "sahih", 3: "sahih", 4: "sahih", 5: "sahih", 6: "sahih",
  7: "sahih", 8: "sahih", 14: "sahih",
  9: "sahih", 10: "sahih", 12: "hasan", 13: "sahih", 15: "sahih", 16: "sahih",
  17: "sahih", 18: "hasan", 19: "hasan", 20: "sahih", 21: "sahih", 22: "sahih",
  23: "sahih", 24: "sahih", 25: "sahih", 26: "sahih", 27: "sahih", 28: "sahih",
  29: "hasan", 30: "hasan", 31: "hasan", 32: "hasan", 33: "hasan", 34: "sahih",
  35: "sahih", 36: "sahih", 37: "sahih", 38: "sahih", 39: "hasan", 40: "sahih",
  41: "daif", 42: "hasan",
};

function withGrade(h: Hadith): Hadith {
  return { ...h, grade: HADITH_GRADES[h.number] };
}
...
export function getHadithOfDay(): Hadith {
  ...
  return withGrade(NAWAWI_HADITHS[index]);
}

export function getAllHadiths(): Hadith[] {
  // Сортируем по каноническому номеру ан-Навави (id могут идти не по порядку,
  // т.к. недостающие хадисы добавлены в конец массива для стабильности id)
  return NAWAWI_HADITHS.map(withGrade).sort((a, b) => a.number - b.number);
}

export function getHadithById(id: number): Hadith | undefined {
  const h = NAWAWI_HADITHS.find((x) => x.id === id);
  return h ? withGrade(h) : undefined;
}
